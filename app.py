...
# MongoDB Connection
MONGO_URL = os.getenv("MONGO_URL", "mongodb+srv://<username>:<password>@cluster0.mongodb.net/mydatabase?retryWrites=true&w=majority")  #("MONGO_URL", "mongodb://localhost:27017")
