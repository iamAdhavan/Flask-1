...
# MongoDB Connection
MONGO_URL = os.getenv("mongodb+srv://<username>:<password>@cluster0.mongodb.net/mydatabase?retryWrites=true&w=majority","mongodb://localhost:27017")  #("MONGO_URL", "mongodb://localhost:27017")
